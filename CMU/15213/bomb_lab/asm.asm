...
0000000000400da0 <main>:
  ...
  400dfb:	be d3 22 40 00       	mov    $0x4022d3,%esi4
...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp  # Border relations with Canada have never been better.
...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp  # 1 2 4 8 16 32
  400efd:	53                   	push   %rbx
...
0000000000400f43 <phase_3>:
   400f43:	48 83 ec 18          	sub    $0x18,%rsp # multiple possible, but I chose 7 327
...
0000000000400fce <func4>:				
  400fce:	48 83 ec 08          	sub    $0x8,%rsp	# I don't like this one, 7 0
